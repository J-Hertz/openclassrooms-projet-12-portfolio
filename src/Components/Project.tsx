...
const Project: React.FC<ProjectProps> = ({
  ...
  return (
    <article className="rounded-xl mt-10 overflow-hidden shadow-xl shadow-slate-300 dark:shadow-slate-900 flex flex-col justify-between">
      <img src={image} alt="" loading="lazy" />
      <div className="dark:bg-dark-card p-4 h-full flex flex-col justify-between">
