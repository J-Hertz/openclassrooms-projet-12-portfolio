...
export async function getPersonalDetails(): Promise<PersonalDetails> {
  const response = await fetch(
    '../openclassrooms-projet-12-portfolio/src/data/personalDetails.json'
  );
...
export async function getSocialMediaUrl(): Promise<SocialMediaUrls> {
  const response = await fetch(
    '../openclassrooms-projet-12-portfolio/src/data/socialMediaUrl.json'
  );
...
export async function getEduDetails(): Promise<EduDetails[]> {
  const response = await fetch(
    '../openclassrooms-projet-12-portfolio/src/data/eduDetails.json'
  );
  const data = await response.json();
  return data;
}
...
export async function getTechStackDetails(): Promise<TechStackDetails> {
  const response = await fetch(
    '../openclassrooms-projet-12-portfolio/src/data/techStackDetails.json'
  );
  const data = await response.json();
  return data;
}
...
export async function getProjectDetails(): Promise<ProjectDetails[]> {
  const response = await fetch(
    '../openclassrooms-projet-12-portfolio/src/data/projectDetails.json'
  );
  const data = await response.json();
  return data;
}
...
export async function getContactDetails(): Promise<ContactDetails> {
  const response = await fetch(
    '../openclassrooms-projet-12-portfolio/src/data/contactDetails.json'
  );
  const data = await response.json();
  return data;
}
